...
UC_TOOL_NAMES = ["agentic_ai_catlog.agentic_ai_schema.get_service_history", "agentic_ai_catlog.agentic_ai_schema.get_return_policy"]
...
VECTOR_SEARCH_TOOLS.append(
        VectorSearchRetrieverTool(
            index_name="agentic_ai_catlog.agentic_ai_schema.product_search_index",
